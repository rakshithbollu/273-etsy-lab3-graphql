...
router.post("/changeprofile", async (req, res) => {
  ...
  const { email, name, city, dateofbirth, mobile, address, country, picture } =
    req.body;
...
router.post("/addgiftoption", async (req, res) => {
  console.log(req.body);
...
router.post("/addgiftdescription", async (req, res) => {
  console.log(req.body);
...
//my cart details
router.post("/getCartDetails", async (req, res) => {
...
// fetching the orders made by a particular end user.
router.post("/mypurchases", [], async (req, res) => {
