...
router.get("/getShopDetails/:shopname", [], async (req, res) => {
...
router.post("/deleteproductfromshop", async (req, res) => {
  console.log(req.body);
...
router.post("/saveshopimage", [], async (req, res) => {
  console.log(req.body);
...
router.post("/getshopcategory", [], async (req, res) => {
  ...
  try {
    let results = await Category.find({
      $or: [{ shopname: shopname }, { shopname: "NULL" }],
    });
    if (results.length === 0) {
...
router.post("/shopcategory", [], async (req, res) => {
  console.log(req.body);
