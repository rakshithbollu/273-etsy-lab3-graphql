    ...
    <Fragment>
      ...
      {orderItems && orderItems.length ? (
        orderItems.map((item) => (
          <ListGroup key={item._id} className="order_item">
            <ListGroup.Item className="order_item_heading">
              {" "}
              ...
              <b>Date:</b> {moment(item.orderdate).format("DD MMM YYYY")}{" "}
            </ListGroup.Item>
            {item.orderdetails && item.orderdetails.length ? (
              <ListGroup.Item>
                ...
                <ListGroup.Item key={orderdetail.product._id}>
                  <Row style={{ textAlign: "center" }}>
                    ...
                    <Col xs={2}>
                      <Link
                        style={{ color: "black" }}
                        to={`/product/${orderdetail.product._id}`}
                      >
                    ...
                    {orderdetail && orderdetail.giftoption === true ? (
                      <Col xs={4} style={{ color: "black" }}>
                        Message : {orderdetail.giftdescription}{" "}
                      </Col>
                    ) : (
                      ""
                    )}
      ...
      <div class="card-body border-top">
        <a href="#" class="btn btn-light">
          {" "}
          <Link to="/products">
            <i class="fa fa-chevron-left"></i>view shopping products{" "}
          </Link>
        </a>
      </div>
    </Fragment>
